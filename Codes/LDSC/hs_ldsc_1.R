...
setwd("~/Desktop/Applied_Genomics/BMEC/control/ldsc/genelist")
...
names(Allfiles) = gsub("_markers.txt", "", filenames)
...
setwd("~/Desktop/Applied_Genomics/BMEC/control/ldsc")
...
All_Genes$geneID= Rah_Gene$Gene.stable.ID[match(paste(All_Genes$geneName),paste(Rah_Gene$Gene.name))]
head(All_Genes)
